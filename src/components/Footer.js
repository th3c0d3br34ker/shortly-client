...
const Footer = () => (
  <>
    <footer className="footer bg-indigo-600 text-white">
      <div className="container max-w-screen-dt mx-auto pt-8 pb-8 lg:pt-20 lg:pb-20 flex flex-col md:flex-row">
        ...
        <div className="w-full lg:w-6/12 sm:pl-4 sm:pr-4 mb-6 md:mb-0 flex items-center justify-evenly md:justify-between flex-col md:flex-row md:items-baseline">
        ...
        <div className="lg:w-3/12 mb-6 md:mb-0">
          <ul className="flex justify-center md:justify-end">
            <li className="footer-sociallink">
              <a href="/">
                <svg xmlns="http://www.w3.org/2000/svg" className="footer-svg">
