  ...
  return (
    <>
      <header className="header container p-8 lg:py-12 flex items-center mx-auto max-w-screen-dt">
        ...
        <div
          className="menu-hamburger ml-auto cursor-pointer md:hidden block"
          onClick={toggleMenu}
        >
          <span className="menu-hamburger__line line--1 block"></span>
          <span className="menu-hamburger__line line--2 block"></span>
          <span className="menu-hamburger__line line--3 block"></span>
        </div>
